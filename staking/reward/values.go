...
var (
	...
	FiveSecStakedBlocks = numeric.NewDecFromBigInt(new(big.Int).Mul(
		big.NewInt(1750*denominations.Nano), big.NewInt(denominations.Nano),
	))
	...
	TwoSecStakedBlocks = numeric.NewDecFromBigInt(new(big.Int).Mul(
		big.NewInt(700*denominations.Nano), big.NewInt(denominations.Nano),
	))
