...
type headerFields struct {
	...
	TransactionMsg        []blockif.TransactionMsg
	TransactionReceiptMsg []blockif.TransactionMsg
}

func (h *Header) SetTransactionReceiptMsg(data []blockif.TransactionMsg) {
	h.fields.TransactionReceiptMsg = data
}
func (h *Header) TransactionReceiptMsg() []blockif.TransactionMsg {
	return h.fields.TransactionReceiptMsg
}

func (h *Header) SetTransactionMsg(data []blockif.TransactionMsg) {
	h.fields.TransactionMsg = data
}
func (h *Header) TransactionMsg() []blockif.TransactionMsg {
	return h.fields.TransactionMsg
}
func (h *Header) DivisionLevel() uint32 {
	return h.fields.DivisionLevel
}
func (h *Header) BlockIDs() []uint32 {
	return h.fields.BlockIDs
}
func (h *Header) Payload() []uint32 {
	return h.fields.Payload
}
func (h *Header) SetDivisionLevel(newDivisionLevel uint32) {
	h.fields.DivisionLevel = newDivisionLevel
}
func (h *Header) SetBlockIDs(blockIDs []uint32) {
	h.fields.BlockIDs = blockIDs
}
func (h *Header) SetPayload(Payload []uint32) {
	h.fields.Payload = Payload
}
